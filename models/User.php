...
class User
{
	...
	/**
	 *  @brief Статический метод для получения данных из таблицы users
	 *
	...
	/**
	 * @brief Статический метод для создания нового пользователя
	 *
	...
	*/
	...
	/**
 	 * @brief Статический метод для изменения данных у пользователя
 	 *
	...
	*/
	...
	/**
 	 * @brief Статический метод для получения id юзера из БД users
 	 *
 	 * @param string $bitcoin Принимает строку биткоина
  ...
  public static function getUserId($bitcoin)
  {
	...
	/**
 	 * @brief	Статический метод для записи данных о юзере в сессию
 	 *
