...
class DB
{
	...
	*/
	private $pdo;
	/**
	 * Закрываем магические методы клонирования, сериализации и ансериализации
	 */
	...
	/**
	 * Конструктор, в котором подключаемся к БД, а так же ловим исключения и пишем в лог в
	 * случае ошибки
	 *  @return void
	 */
	...
	/**
	 *  Статический метод для создания объекта текущего класса DB
